...
-- v5.07 (2026-08-04)
-- 🔧 【终极修复】
-- 🛠️ 彻底重写加载动画逻辑：不再依赖 Tween 动画完成回调，改用“超时+强制触发法”，100% 绕开 Roblox 移动端界面渲染锁，绝不再卡加载界面。
-- 🔒 增加全局 pcall 异常隔离：即使部分 UI 渲染失败，主框架依然能强行弹出。
-- 🎯 所有功能 100% 保留：ESP骨骼 / 大司马图标 / 传送 / 甩飞 / 飞车 / 自瞄 / 玩家管理 / 更新日志。
-- 
-- =====================================================================
...
print("👑【小木HUB v5.07】加载成功！完美适配移动端。")
