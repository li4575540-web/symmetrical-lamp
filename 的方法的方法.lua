...
-- v5.04 (2026-08-04)
-- 🚀 【重要修复与优化】
-- 🔧 崩溃修复：彻底修复移动端(PE)搜索框导致脚本崩溃的问题。
-- 🔧 将 TextInputBegan 替换为官方标准 TextInputChanged，兼容性大幅提升。
-- 📱 移动端适配：优化 UI 触摸响应，长按/滑动条拖拽更丝滑。
-- ⚡ 加载优化：优化 pcall 保护机制，不会卡黑屏。
-- 
-- v5.03 (2026-08-04)
-- 🔧 修复搜索框事件引起的崩溃。
-- 
...
-- 🔥 核心修复：使用标准 TextInputChanged，最稳
searchInput.TextInputChanged:Connect(function(text)
...
flingTitle.Position = UDim2.new(0.05, 0, 0.1, 0)
...
print("👑【小木HUB v5.04】加载成功！完美适配移动端。")
